...
- **Local Model Robustness**: Mem0 strips markdown wrappers, noisy preambles, and `<think>` blocks when extracting JSON-like outputs from local models such as Qwen and Gemma
